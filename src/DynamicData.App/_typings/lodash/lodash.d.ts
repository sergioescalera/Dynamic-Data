	...
	**********/
    ...
    interface LoDashArrayWrapper<T> {
		...
		**/
        ...
        sortBy<T>(
            iteratees: string[] | string): LoDashArrayWrapper<T>;
    ...
    interface LoDashObjectWrapper<T> {
		...
		**/
        ...
        sortBy<T extends {}>(
            iteratees: string[]): LoDashObjectWrapper<T>;

        sortBy<T extends {}, TSort>(
            iteratees: ListIterator<T, TSort>): LoDashObjectWrapper<T>;
