...
//# sourceMappingURL=EntityTypeSerialization.js.map
var DynamicData;
(function (DynamicData) {
    var Core;
    (function (Core) {
...
//# sourceMappingURL=IAttributeType.js.map
var DynamicData;
(function (DynamicData) {
    var Core;
    (function (Core) {
...
//# sourceMappingURL=IEntityTypeSettings.js.map
var DynamicData;
(function (DynamicData) {
    var Core;
    (function (Core) {
    ...
    (function (Data) {
        ...
        var SampleData = /** @class */ (function () {
            ...
            SampleData.prototype.Install = function () {
                ...
                var result = this._entityTypeRepository.BulkCreate(types);
...
(function (DynamicData) {
    ...
    (function (ViewModels) {
        ...
        var SettingsViewModel = /** @class */ (function (_super) {
            ...
            SettingsViewModel.prototype.InstallSampleData = function () {
    ...
    (function (UI) {
        ...
        (function (Directives) {
            ...
            var EntityQuickViewForm = /** @class */ (function () {
                function EntityQuickViewForm(scope, templateCache, templateRepository) {
                    var _this = this;
                    DynamicData.Core.Trace.Message(Directives.entityQuickViewFormName + ".constructor");
                    templateRepository
                        .GetByName(scope.entity.Type.Name)
                        .then(function (template) {
                        var templateName = "quick-view-" + scope.entity.Type.Name;
                        templateCache.put(templateName, template.quickView);
                        _this.TemplateUrl = templateName;
                    });
                }
                EntityQuickViewForm.$inject = [
                    "$scope",
                    "$templateCache",
...
//# sourceMappingURL=IFieldEditorScope.js.map
var DynamicData;
(function (DynamicData) {
    var UI;
    (function (UI) {
    ...
    (function (UI) {
        ...
        (function (Filters) {
            ...
            angular.module(DynamicData.Config.appName)
                .filter("format", [
                function () {
                    return function (value, typeCode) {
...
//# sourceMappingURL=DashboardPivotItemController.js.map
var DynamicData;
(function (DynamicData) {
    var UI;
    (function (UI) {
